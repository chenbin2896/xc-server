...
public enum MediaCode implements ResultCode {
    ...
    //操作代码
    @Schema(name = "媒资系统操作是否成功", example = "true", requiredMode = Schema.RequiredMode.REQUIRED)
    boolean success;
    //操作代码
    @Schema(name = "媒资系统操作代码", example = "22001", requiredMode = Schema.RequiredMode.REQUIRED)
    int code;
    //提示信息
    @Schema(name = "媒资系统操作提示", example = "文件在系统已存在！", requiredMode = Schema.RequiredMode.REQUIRED)
    String message;
